const arr = ["red", "blue", "organge", "green", "sky"];
const arr1 = [...arr, "voilet", "black"];
...
birthday(person.name, person.age);

const arr3 = [1, 2, 3, 4];
const addTwo = (num) => num + 2;
arr3.forEach((num) => addTwo(num));

arrraayy = [1, 3, 5, 2, 22, 11, 9];

const sumOdd = arrraayy.reduce((previousValue, currentValue) => {
  if (currentValue % 2 === 0) {
